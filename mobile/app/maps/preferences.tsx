...
export default function PreferencesScreen() {
  ...
  const { vehicleProfile, destination, setPreferences, setResults, routeOffsetKm, setRouteOffsetKm } =
    useRecommendation();
      ...
      <Content>
        ...
        <SummaryContainer>
          ...
          <SummaryRow>
            ...
            <SummaryValue>
              {offsetUnit === "km" ? offsetValue : (parseFloat(offsetValue) / 1000).toFixed(2)} km
            </SummaryValue>
          </SummaryRow>
        </SummaryContainer>
