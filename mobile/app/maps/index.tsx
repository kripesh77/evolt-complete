...
export default function HomeScreen() {
  ...
  const { location, hasPermission, isLoading, requestPermission } =
    useLocation();
  const { hasResults, routeInfo, searchArea, recommendations, clearAll, radius, setRadius, setNearbyStations } =
    useRecommendation();
  ...
  return (
    <Container>
            ...
            <Marker
              ...
              onCalloutPress={() =>
                router.push({
                  ...
                  params: { stationId: station.stationId, isRecommended: "true" },
                })
              }
            />
          ))}
          ...
          nearbyStations.map((station) => (
            <Marker
              ...
              onCalloutPress={() =>
                router.push({
                  pathname: "/stations/[stationId]",
                  params: { stationId: station.stationId, isRecommended: "false" },
                })
              }
            />
          ))}
      ...
      <ButtonsContainer>
        {hasResults ? (
          <BottomActionButton text="Clear & Go Back" onPress={handleClearResults} />
        ) : (
          <BottomActionButton
